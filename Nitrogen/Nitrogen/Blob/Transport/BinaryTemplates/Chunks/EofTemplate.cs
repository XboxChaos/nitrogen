...
{
    /// <summary>
    /// Defines the structure of the '_eof' (end-of-file) footer chunk.
    /// </summary>
    public class EofTemplate
        : ChunkTemplate
    {
        public override string ChunkSignature { get { return "_eof"; } }

        public override bool IsWellDefined { get { return false; } }
